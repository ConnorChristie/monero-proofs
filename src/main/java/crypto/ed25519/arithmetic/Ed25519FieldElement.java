...
public class Ed25519FieldElement {
    ...
    public Ed25519FieldElement multiply(final Ed25519FieldElement g) {
         ...
         * f1 * g9 really is f1 * 2^26 * g9 * 2^230 = f1 * g9 * 2^256 = 2 * f1 * g9 * 2^255 congruent 2 * 19 * f1 *
         * g9 * 2^0 modulo p.
     ...
     *     x = h - q * (2^255 - 19) + 19 * 2^-255 * (h - q * (2^255 - 19)) + 1/2 - 19^2 * 2^-255 * q - 19 * 2^-255 *
     *     (h - 2^230 * h9)
     *       = h - q * 2^255 + 19 * q + 19 * 2^-255 * h - 19 * q + 19^2 * 2^-255 * q + 1/2 - 19^2 * 2^-255 * q - 19 *
     *       2^-255 * h + 19 * 2^-25 * h9
